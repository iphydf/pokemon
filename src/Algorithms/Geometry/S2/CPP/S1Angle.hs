...
foreign import ccall c_S1Angle_e5          :: Ptr Int32   -> Ptr S1Angle                -> IO ()
foreign import ccall c_S1Angle_e6          :: Ptr Int32   -> Ptr S1Angle                -> IO ()
foreign import ccall c_S1Angle_e7          :: Ptr Int32   -> Ptr S1Angle                -> IO ()
